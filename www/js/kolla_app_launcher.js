...
var appLauncher = new function () {
    ...
    this.init = function (appLauncherDataParam) {
        ...
        html_usuario += "<span class='glyphicon glyphicon-user'></span>";
        html_usuario += "       </div>";
        ...
        if (appLauncherData.data.usuario_id != undefined) {
            $base
                ...
                .append( $('<div/>', {
                    id: 'usuario_boton_cuenta_id_',
                    //text: appLauncherData.data.usuario_id
                    text: appLauncherData.data.kolla_usuario_id,
                    class: 'arai-fix-div'
                }));
        }
        ...
        // Para kolla sacamos esto... mucho rediseño del header para algo que solo es un "nice to have"
        //////////////////////////////////////////////////////////////////////////////////////////////////////
