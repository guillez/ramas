...
class manejador_rest_arai_usuarios
{
    ...
    static function instancia($recargar=false)
    {
        if (!isset(self::$instancia) || $recargar) {
            self::$instancia = new manejador_rest_arai_usuarios($recargar);
        }
     ...
     * @throws toba_error
     */
    public function get_atributo($identificador, $atributo)
    {
        $query = $datos = array();
        $url = 'usuarios/'.$identificador.'/atributos/'.$atributo;
    ...
    public function get_atributos($identificador)
    {
        $query = $datos = array();
        $url = 'usuarios/'.$identificador.'/atributos';
