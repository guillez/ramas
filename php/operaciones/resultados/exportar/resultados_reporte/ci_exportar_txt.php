...
class ci_exportar_txt extends ci_navegacion_por_ug_reportes
{
    ...
    function cargar_filtro($filtro)
    {
        ...
        $this->s__formulario = $filtro['formulario_habilitado'];
    ...
    function evt__filtro__exportar($filtro)
    {
        ...
        if ($this->cargar_filtro($filtro)) {
            ...
            switch ($this->s__reporte_tipo) {
                case 1:
                    $id_item = ITEM_REPORTE_ENCUESTADO;
                    $tipo_reporte = REPORTE_ENCUESTADO;
                    break;
                case 2:
                    $id_item = ITEM_REPORTE_PREGUNTA;
                    $tipo_reporte = REPORTE_PREGUNTA;
                    break;
            }
