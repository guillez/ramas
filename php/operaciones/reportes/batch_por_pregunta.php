...
global $argv;
	...
	if ( isset($filtro) ) {
		...
		//Reporte de encuesta ordenado por pregunta, en txt
		$contenido = $reportes->reporte_por_pregunta_txt($filtro, $estado_proceso);
		
		$nombre = date('Ymd-Hi').'_por_pregunta_e'.$filtro['encuesta'].'_h'.$filtro['habilitacion'].'_i'.$filtro['inconclusas'];
