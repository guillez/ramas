...
global $argv;
	...
	{	$reportes = new reportes_kolla();
		//Reporte de preguntas de respuesta multiple, en txt
		$contenido = $reportes->reporte_por_encuestado_solo_multiples_txt($filtro, $estado_proceso);
	
		$nombre = date('Ymd-Hi').'_multiples_encuestado_e'.$filtro['encuesta'].'_h'.$filtro['habilitacion'].'_i'.$filtro['inconclusas'];
