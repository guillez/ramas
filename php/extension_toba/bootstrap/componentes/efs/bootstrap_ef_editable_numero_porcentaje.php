...
class bootstrap_ef_editable_numero_porcentaje extends \toba_ef_editable_numero_porcentaje
{
	...
	function get_input()
	{
		...
		$input = bootstrap_form::text($this->id_form, $this->estado,$this->es_solo_lectura(),$this->maximo,$this->tamano, 'control-form', $this->javascript.' '.$this->input_extra.$tab);
