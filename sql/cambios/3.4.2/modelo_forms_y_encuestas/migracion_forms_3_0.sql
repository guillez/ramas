...
WHERE (encuesta <=2  AND encuesta in (SELECT encuesta FROM kolla.sge_encuesta_habilitada seh)) 
    OR (encuesta > 2);
...
SELECT      u.encuestado, NULL,  NULL, ei.habilitacion, NULL, 'N', 'S', 'OK', ei.fecha
