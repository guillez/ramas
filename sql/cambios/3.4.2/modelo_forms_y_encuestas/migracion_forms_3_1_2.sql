...
/* Se agrega la inserción de datos en la tabla int_ingenieria_relevamiento en este script */
...
--Las encuestas 1 a 4 se insertarán con sus nuevos ids en un script posterior. En este punto se migra todo lo que haya
...
WHERE (encuesta <= 4  AND encuesta in (SELECT encuesta FROM kolla.sge_encuesta_habilitada seh)) 
    OR (encuesta > 4);
