------------------------------------------------------------
--[47000003]--  sge_puntaje_aplicacion 
------------------------------------------------------------
...
INSERT INTO apex_objeto_db_registros_col (objeto_proyecto, objeto, col_id, columna, tipo, pk, secuencia, largo, no_nulo, no_nulo_db, externa, tabla) VALUES (
	...
	'47000003', --objeto
	'40000389', --col_id
	'puntaje_aplicacion', --columna
	'E', --tipo
	'1', --pk
	'sge_puntaje_aplicacion_seq', --secuencia
	NULL, --largo
	NULL, --no_nulo
	'1', --no_nulo_db
	'0', --externa
...
INSERT INTO apex_objeto_db_registros_col (objeto_proyecto, objeto, col_id, columna, tipo, pk, secuencia, largo, no_nulo, no_nulo_db, externa, tabla) VALUES (
	...
	'47000003', --objeto
	'40000392', --col_id
	'formulario_habilitado_detalle', --columna
	'E', --tipo
	'0', --pk
	'', --secuencia
	NULL, --largo
...
INSERT INTO apex_objeto_db_registros_uniq (objeto_proyecto, objeto, uniq_id, columnas) VALUES (
	...
	'47000003', --objeto
	'40000001', --uniq_id
	'evaluacion,formulario_habilitado,formulario_habilitado_detalle,puntaje'  --columnas
);
--- FIN Grupo de desarrollo 40
